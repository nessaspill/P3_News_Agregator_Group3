...
# SQL statement
$sql = $sql = "SELECT t.CategoryID, t.Title, m.CategoryID, m.Title, s.CategoryID, s.Title FROM feed_category_travel t LEFT JOIN feed_category_music m ON t.CategoryID = m.CategoryID LEFT JOIN feed_category_sea_creatures s ON t.CategoryID = s.CategoryID";
